...
enum AppTranslations {
    static let table: [AppLanguage: [String: String]] = [
        .english: [
            ...
            "foundProcess": "Found process: %@ (PID %@)",
            ...
            "forceKillMessageDetail": "This will run kill -9 on %@ (PID %@).",
        ...
        .simplifiedChinese: [
            ...
            "forceKillMessageDetail": "将对 %@ (PID %@) 执行 kill -9。",
            "noProcessInfo": "无进程信息",
            "unknownError": "未知错误",
        ...
        .traditionalChinese: [
            ...
            "forceKillMessageDetail": "將對 %@ (PID %@) 執行 kill -9。",
            "noProcessInfo": "無程序資訊",
            "unknownError": "未知錯誤",
        ...
        .japanese: [
            ...
            "forceKillMessageDetail": "%@ (PID %@) に kill -9 を実行します。",
        ...
        .german: [
            ...
            "foundProcess": "Gefundener Prozess: %@ (PID %@)",
            ...
            "forceKillMessageDetail": "kill -9 wird für %@ (PID %@) ausgeführt.",
        ...
        .french: [
            ...
            "foundProcess": "Processus trouvé : %@ (PID %@)",
            ...
            "forceKillMessageDetail": "Ceci exécutera kill -9 sur %@ (PID %@).",
        ...
        .spanish: [
            ...
            "foundProcess": "Proceso encontrado: %@ (PID %@)",
            ...
            "forceKillMessageDetail": "Esto ejecutará kill -9 sobre %@ (PID %@).",
